...
// import type NodemailerConfig from "node_modules/next-auth/providers/nodemailer"
// import { text } from "stream/consumers" // не нужно
                        ...
                        <tr>
                            <td align = "center" style = "border-radius: 5px;"
                                ...
                                <a href = "${url}"
                                    ...
                                    border-radius: 5px; padding: 10px 5px; border: 1px solid ${color.buttonBorder};
